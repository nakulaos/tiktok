...
type (
	...
	CommentActionRevertResponse = comment.CommentActionRevertResponse
	...
	FindCommentResp             = comment.FindCommentResp
	PrepareCommentAction        = comment.PrepareCommentAction
	User                        = comment.User
...
func (m *defaultCommentSrv) CommentActionRevert(ctx context.Context, in *CommentActionRequest, opts ...grpc.CallOption) (*CommentActionResponse, error) {
	client := comment.NewCommentSrvClient(m.cli.Conn())
	return client.CommentActionRevert(ctx, in, opts...)
}
...
func (m *defaultCommentSrv) PrepareCommentAction(ctx context.Context, in *CommentActionRequest, opts ...grpc.CallOption) (*PrepareCommentAction, error) {
	client := comment.NewCommentSrvClient(m.cli.Conn())
	return client.PrepareCommentAction(ctx, in, opts...)
}

func (m *defaultCommentSrv) FindComment(ctx context.Context, in *CommentActionRequest, opts ...grpc.CallOption) (*FindCommentResp, error) {
	client := comment.NewCommentSrvClient(m.cli.Conn())
