...
type (
	...
	IncrCommentCountReq  = feed.IncrCommentCountReq
	IncrCommentCountResp = feed.IncrCommentCountResp
...
func (m *defaultFeed) IncrCommentCount(ctx context.Context, in *IncrCommentCountReq, opts ...grpc.CallOption) (*IncrCommentCountResp, error) {
	client := feed.NewFeedClient(m.cli.Conn())
	return client.IncrCommentCount(ctx, in, opts...)
}

func (m *defaultFeed) IncrCommentCountRevert(ctx context.Context, in *IncrCommentCountReq, opts ...grpc.CallOption) (*IncrCommentCountResp, error) {
	client := feed.NewFeedClient(m.cli.Conn())
	return client.IncrCommentCountRevert(ctx, in, opts...)
}
