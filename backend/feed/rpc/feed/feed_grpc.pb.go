...
const (
	...
	Feed_IncrCommentCount_FullMethodName       = "/feed.Feed/IncrCommentCount"
	Feed_IncrCommentCountRevert_FullMethodName = "/feed.Feed/IncrCommentCountRevert"
)
...
type FeedClient interface {
	...
	IncrCommentCountRevert(ctx context.Context, in *IncrCommentCountReq, opts ...grpc.CallOption) (*IncrCommentCountResp, error)
}
...
func (c *feedClient) IncrCommentCount(ctx context.Context, in *IncrCommentCountReq, opts ...grpc.CallOption) (*IncrCommentCountResp, error) {
	out := new(IncrCommentCountResp)
	err := c.cc.Invoke(ctx, Feed_IncrCommentCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedClient) IncrCommentCountRevert(ctx context.Context, in *IncrCommentCountReq, opts ...grpc.CallOption) (*IncrCommentCountResp, error) {
	out := new(IncrCommentCountResp)
	err := c.cc.Invoke(ctx, Feed_IncrCommentCountRevert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FeedServer interface {
	...
	IncrCommentCountRevert(context.Context, *IncrCommentCountReq) (*IncrCommentCountResp, error)
...
func (UnimplementedFeedServer) IncrCommentCount(context.Context, *IncrCommentCountReq) (*IncrCommentCountResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IncrCommentCount not implemented")
}
func (UnimplementedFeedServer) IncrCommentCountRevert(context.Context, *IncrCommentCountReq) (*IncrCommentCountResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IncrCommentCountRevert not implemented")
}
...
func _Feed_IncrCommentCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IncrCommentCountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FeedServer).IncrCommentCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Feed_IncrCommentCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServer).IncrCommentCount(ctx, req.(*IncrCommentCountReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Feed_IncrCommentCountRevert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IncrCommentCountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FeedServer).IncrCommentCountRevert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Feed_IncrCommentCountRevert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServer).IncrCommentCountRevert(ctx, req.(*IncrCommentCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Feed_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Feed_IncrCommentCount_Handler,
		},
		{
			MethodName: "IncrCommentCountRevert",
			Handler:    _Feed_IncrCommentCountRevert_Handler,
		},
	},
