...
import (
	...
	"tiktok/feed/rpc/internal/logic"
...
func (s *FeedServer) IncrCommentCount(ctx context.Context, in *feed.IncrCommentCountReq) (*feed.IncrCommentCountResp, error) {
	l := logic.NewIncrCommentCountLogic(ctx, s.svcCtx)
	return l.IncrCommentCount(in)
}

func (s *FeedServer) IncrCommentCountRevert(ctx context.Context, in *feed.IncrCommentCountReq) (*feed.IncrCommentCountResp, error) {
	l := logic.NewIncrCommentCountRevertLogic(ctx, s.svcCtx)
	return l.IncrCommentCountRevert(in)
}
