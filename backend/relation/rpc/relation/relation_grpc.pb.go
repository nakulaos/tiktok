...
type RelationClient interface {
	...
	GetFollowCount(ctx context.Context, in *FollowerCountReq, opts ...grpc.CallOption) (*FollowerCountResp, error)
...
func (c *relationClient) GetFollowCount(ctx context.Context, in *FollowerCountReq, opts ...grpc.CallOption) (*FollowerCountResp, error) {
...
type RelationServer interface {
	...
	GetFollowCount(context.Context, *FollowerCountReq) (*FollowerCountResp, error)
...
func (UnimplementedRelationServer) GetFollowCount(context.Context, *FollowerCountReq) (*FollowerCountResp, error) {
...
func _Relation_GetFollowCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelationServer).GetFollowCount(ctx, req.(*FollowerCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
